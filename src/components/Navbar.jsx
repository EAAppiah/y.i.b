    ...
    <>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            {/* Logo */}
            <div className="w-[100px] sm:w-[120px] lg:w-[200px]">
      ...
      >
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <a
            href="tel:+233535686563"
            className="mt-10 sm:mt-12 flex items-center gap-3 text-white hover:text-orange-500 transition-colors duration-300"
          >
            <FaPhoneVolume className="w-4 h-4 sm:w-5 sm:h-5" />
            <span className="text-base sm:text-lg">(+233) 53-568-6563</span>
          </a>
        </div>
      </div>
    </>
