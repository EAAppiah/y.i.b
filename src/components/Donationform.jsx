...
const DonationForm = ({ isFormVisible, setIsFormVisible }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await emailjs.send(
        'service_pv9uhxk', // Get from EmailJS dashboard
        'template_qj2rezc', // Get from EmailJS dashboard
        emailParams,
        'je6afNyIYkHm5ldTB' // Get from EmailJS dashboard
      );
